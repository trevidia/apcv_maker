    ...
    <div id="form-container">
        ...
        */
        ...
        <div class="form-container">
            <div><h3 style="font-size: 25px; font-weight: 700; line-height: 29.3px;">Distinguish Honours, Distinctions &
                    Membership of Learned Societies</h3></div>
            <h5 style="padding-bottom: 20px; font-weight: 700; font-size: 12px; line-height: 27.72px;">Please kindly
                fill this form</h5>

            <div class="dis" style="font-size: 15px; font-weight: 400; line-height: 17.44px; padding-bottom: 8px;">
            ...
            <div><input type="text" name="best" placeholder="Best Graduating Student"
                        style="height: 45px; width: 572px; border: 2px solid #1f1f1f; font-size: 15px; font-weight: 400; border-radius: 5px; padding-left: 11px;">
            </div>
