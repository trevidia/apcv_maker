...
<body>
    <div id="root">
        ...
        echo drawer($domain, ["publications", 'booksAcceptedPub']);
        ?>
        <?php
     ...
     */
        ...
        */
            ...
            <div class="container">
                ...
                <h1>Book Already Accepted for Publication</h1>
                ...
                <div>
                    <input type="submit" name="submit" style="color: white; width: 294px; height: 37px; background-color: black; border-radius: 6px; font-family: Roboto; 
            font-size: 150%;" value="+ Add New Publisher"><br />
                </div><br />
                        ...
                        <form enctype="multipart/form-data" action="" method="post" class="col-md-12">
                            <div style="border: none; width: 431px; height: 38px; background: #1f1f1f; border-radius: 5px; text-align: center; font-weight: 400; font-size: 25px; color: #f8f9fa; line-height: 29.3px;">
                                <label for="file" class="filebutton">
                                    <div style="text-transform: uppercase; padding-top: 5px; line-height: 29.9px;">Select File</div>
                                </label>
                            </div>
                ...
                <div>
                    <input type="text" name="submit" style="height: 32px; width: 522px; border: 1px solid black;" value=" ">
                </div><br />
                <div>
                    <p >Authors:</p><br />
                ...
                <select style="width: 153px; height: 32px;">
                    ...
                    <option value="Year" selected>Year<optiion>
                    <option>
                        </optiion>
                    <option>
                        </optiion>
                ...
                <div style="padding-right: 2px;">
                    <input type="submit" name="submit" style="color: white; width: 431px; height: 38px; 
    background-color: black; font-size: 150%; border-radius: 6px; font-family: Roboto;  font-weight: 500" value=" Save and Continue"><br />
                </div>
